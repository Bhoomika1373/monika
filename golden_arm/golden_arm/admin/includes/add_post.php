<?php
    if(isset($_POST['create_post'])){
        ...
        $query = "INSERT INTO dishes(dish_category_id,dish_name,dish_price,dish_tags,dish_content,dish_date,dish_status,dish_image)";
        $query .= "VALUE({$dish_category_id},'{$dish_name}','{$dish_price}','{$dish_tags}',
